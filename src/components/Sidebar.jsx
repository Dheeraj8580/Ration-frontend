...
const Sidebar = ({ userType = 'user' }) => {
  ...
  return (
    <aside className="no-print w-72 flex-shrink-0 bg-white border-r border-slate-200 h-screen sticky top-0 flex flex-col z-30 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
      {/* Logo Section */}
      <div className="p-8">
